...
class Share {
	 ...
	 */
	public static function shareItem($itemType, $itemSource, $shareType, $shareWith, $permissions, $itemSourceName = null, $expirationDate = null) {
...
// 		}
	...
	private static function put($itemType, $itemSource, $shareType, $shareWith, $uidOwner,
		$permissions, $parentFolder = null, $token = null, $itemSourceName = null, $expirationDate = null) {
		$backend = self::getBackend($itemType);
		...
		if ($checkReshare = self::getItemSharedWithBySource($itemType, $itemSource, self::FORMAT_NONE, null, true)) {
			...
			if (self::isResharingAllowed() && (int)$checkReshare['permissions'] & PERMISSION_SHARE) {
				if (~(int)$checkReshare['permissions'] & $permissions) {
					...
					$expirationDate = min($expirationDate, $checkReshare['expiration']); //TODO
				}
			} else {
