...
<fieldset id="mail_settings" class="personalblock">
	...
	<p id="setting_smtpauth" <?php if ($_['mail_smtpmode'] != 'smtp') print_unescaped(' style="display: none;"'); ?>>
	...
	<p id="setting_smtphost" <?php if ($_['mail_smtpmode'] != 'smtp') print_unescaped(' style="display: none;"'); ?>>
	...
	<p id="setting_smtpsecure" <?php if ($_['mail_smtpmode'] != 'smtp') print_unescaped(' style="display: none;"'); ?>>
	...
	<p id="mail_credentials" <?php if (!$_['mail_smtpauth'] || $_['mail_smtpmode'] != 'smtp') print_unescaped(' style="display: none;"'); ?>>
